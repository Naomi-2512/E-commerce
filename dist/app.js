...
class DisplayItems {
    ...
    amountUpload = document.querySelector('#uploadAmount');
    createButton = document.querySelector('#create');
    viewAllButton = document.querySelector('#viewAll');
    // viewOneButton = document.querySelector('.viewOneButton') as HTMLButtonElement;
    container = document.querySelector('.container');
    updater = document.querySelector('.updater');
    imageStorage = document.querySelector('#uploaderImage');
    productStorage = document.querySelector('#uploaderProduct');
    descriptionStorage = document.querySelector('#uploaderDescription');
    amountStorage = document.querySelector('#uploaderAmount');
        ...
        try {
            ...
            displayArray.forEach((element, index) => {
                ...
                viewOneButton.addEventListener('click', (event) => {
                    ...
                    let myName = element.productName;
                    console.log(myName);
                ...
                updateButton.addEventListener('click', () => {
                    ...
                    this.imageStorage = document.querySelector('#uploaderImage');
                    this.productStorage = document.querySelector('#uploaderProduct');
                    this.descriptionStorage = document.querySelector('#uploaderDescription');
                    this.amountStorage = document.querySelector('#uploaderAmount');
    ...
    async displayItemsByName(name, myIdentity) {
        try {
